...
public class VoteTester {
    ...
    public static void triggerTestVote(CommandSender sender, String targetName, String serviceName, MessageHandler messageHandler) {
        ...
        messageHandler.send(sender, "<prefix> <green>Triggered vote event for <white>" + targetName + "</white> via <white>" + serviceName + "</white>.");
    }
}
