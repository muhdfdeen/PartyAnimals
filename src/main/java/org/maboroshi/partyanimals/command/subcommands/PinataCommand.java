...
public class PinataCommand {
    ...
    private LiteralArgumentBuilder<CommandSourceStack> buildStart() {
        return Commands.literal("start")
                ...
                .then(Commands.argument("pinata", StringArgumentType.word())
                        ...
                        .executes(ctx -> handleStart(ctx.getSource(), null, StringArgumentType.getString(ctx, "pinata")))
                        .then(Commands.argument("location", StringArgumentType.word())
                                .suggests(this::suggestCentralLocations)
                                .executes(ctx -> handleStart(ctx.getSource(), StringArgumentType.getString(ctx, "location"), StringArgumentType.getString(ctx, "pinata")))));
    }
    ...
    private LiteralArgumentBuilder<CommandSourceStack> buildSpawn() {
        return Commands.literal("spawn")
                ...
                .then(Commands.argument("pinata", StringArgumentType.word())
                        .suggests(this::suggestPinataTemplates)
                        .executes(ctx -> handleSpawn(ctx.getSource(), null, StringArgumentType.getString(ctx, "pinata")))
                        .then(Commands.argument("location", StringArgumentType.word())
                                .suggests(this::suggestCentralLocations)
                                .executes(ctx -> handleSpawn(ctx.getSource(), StringArgumentType.getString(ctx, "location"), StringArgumentType.getString(ctx, "pinata")))));
    }
